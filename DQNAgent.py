...
# DeepQLearning Vanilla DQN (TowardsDatascience):
# 1:gather and store samples in replay buffer with current policy
# 2:random sample batches of experiences from the replay buffer
# 3:use sampled experiences to update Q network
# 4:repeat 1-3
